...
var bufferParsers = [
  ...
  function methodDefinition(node, position, buffer) {
    ...
    node.key = convertNode2(node, scope, buffer[position + 1], buffer);
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-IVI3UPJ3.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-IDHA7FFA.js.map
